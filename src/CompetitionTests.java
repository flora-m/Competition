...
//  testing on my computer
	String file0 = "C:\\Uni\\CS\\java\\Competition\\data\\tinyEWD.txt";
	String file1 = "C:\\Uni\\CS\\java\\Competition\\data\\tinyTest.txt";
	String file2 = "C:\\Uni\\CS\\java\\Competition\\data\\empty.txt";
	...
	public void testDijkstraConstructor() {
		...
		CompetitionDijkstra dijkstra = new CompetitionDijkstra(file0, 60, 70, 80);
	...
	public void testGetStreets() {
		CompetitionDijkstra dijkstra = new CompetitionDijkstra(file1, 60, 70, 80);
		dijkstra.createMap();
	...
	public void testGetDist() {
		...
		ArrayList<CompetitionDijkstra.Street> streets = new ArrayList<CompetitionDijkstra.Street>();
		streets.add(street);
		//		assertEquals("Testing getTo() method", 260, street.getDist(), 0.000001);
...
//	}
	...
	public void testDijkstraInvalidSpeed1() {
		...
		CompetitionDijkstra dijkstra = new CompetitionDijkstra(file0, 30, 70, 80);
		assertEquals("Testing isValidSpeed with invalid walking speed", -1, dijkstra.createMap());
	}

	@Test
	public void testDijkstraInvalidSpeed2() {
		CompetitionDijkstra dijkstra = new CompetitionDijkstra(file0, 110, 70, 80);
		assertEquals("Testing isValidSpeed with invalid walking speed", -1, dijkstra.createMap());		
	}
	...
	//				assertEquals("Testing createMap with valid walking speed", 0, dijkstra.createMap());	
	//			}
	...
	public void testEmptyFile() {
		CompetitionDijkstra dijkstra = new CompetitionDijkstra(file2, 60, 70, 80);
	...
	public void testFWConstructor() {
		CompetitionFloydWarshall fw = new CompetitionFloydWarshall(file0, 60, 70, 80);
...
//	}
	...
	public void testFWEmptyFile() {
		CompetitionFloydWarshall fw = new CompetitionFloydWarshall(file2, 60, 70, 80);
		assertEquals("Testing FW constructor with empty file input", -1, fw.timeRequiredforCompetition());
	}

	@Test
	public void testFWInvalidSpeed1() {
		CompetitionFloydWarshall fw = new CompetitionFloydWarshall(file0, 30, 70, 80);
	...
	public void testFWInvalidSpeed2() {
		CompetitionFloydWarshall fw = new CompetitionFloydWarshall(file0, 60, 70, 1000);
		assertEquals("Testing FW constructor with invalid speed input", -1, fw.timeRequiredforCompetition());
	}
